 ...
 */
import { classifySelector, SelectorType, parse as parseCssSelector, indexOfPseudoDirective, destructAST, } from '@ghostery/adblocker-extended-selectors';
...
export default class CosmeticFilter {
    ...
    static parse(line, debug = false) {
        ...
        if (line.charCodeAt(suffixStartIndex) === 94 /* '^' */) {
            ...
            if (selectorType === SelectorType.Extended) {
                ...
                mask = setBit(mask, 64 /* COSMETICS_MASK.extended */);
            }
        ...
        if (parentDomains !== undefined && getBit(mask, 2 /* COSMETICS_MASK.scriptInject */) === false) {
            return null;
        }
        // Extended selectors should always be specific to some domain.
        if (domains === undefined && getBit(mask, 64 /* COSMETICS_MASK.extended */) === true) {
            return null;
        }
        if (selector !== undefined) {
            ...
            if (getBit(mask, 2 /* COSMETICS_MASK.scriptInject */) === false &&
                getBit(mask, 64 /* COSMETICS_MASK.extended */) === false &&
    ...
    isExtended() {
        return getBit(this.mask, 64 /* COSMETICS_MASK.extended */);
    }
    /**
