...
function detectFilterType(line, { extendedNonSupportedTypes = false } = {}) {
    ...
    if (line.length === 0 || line.length === 1) {
        if (extendedNonSupportedTypes) {
            return 100 /* FilterType.NOT_SUPPORTED_EMPTY */;
        }
    ...
    if (firstCharCode === 33 /* '!' */ ||
        ...
        if (extendedNonSupportedTypes) {
            return 101 /* FilterType.NOT_SUPPORTED_COMMENT */;
        }
        return 0 /* FilterType.NOT_SUPPORTED */;
    }
    ...
    if (dollarIndex !== -1 && dollarIndex !== line.length - 1) {
        ...
        if (afterDollarCharCode === 36 /* '$' */ ||
            ...
            if (extendedNonSupportedTypes) {
                return 102 /* FilterType.NOT_SUPPORTED_ADGUARD */;
            }
            return 0 /* FilterType.NOT_SUPPORTED */;
        }
    }
        ...
        if (filterType === 1 /* FilterType.NETWORK */ && config.loadNetworkFilters === true) {
            ...
            if (filter !== null) {
                ...
                notSupportedFilters.push({
                    lineNumber: i,
                    filter: line,
                    filterType: 2 /* FilterType.COSMETIC */,
                });
            }
        }
            ...
            if (preprocessorToken === 1 /* PreprocessorTokens.BEGIF */) {
                const condition = preprocessor_js_1.default.getCondition(line);
                conditions.push(condition);
                const nextCondition = (0, preprocessor_js_1.joinConditions)(conditions);
                preprocessor = preprocessors.get(nextCondition);
                if (preprocessor === undefined) {
                    preprocessor = new preprocessor_js_1.default({
                ...
                conditions.pop();
                preprocessor = preprocessors.get((0, preprocessor_js_1.joinConditions)(conditions)) || null;
            }
            else if (preprocessorToken === 2 /* PreprocessorTokens.ELSE */ && conditions.length > 0) {
            ...
            else if (filterType === 102 /* FilterType.NOT_SUPPORTED_ADGUARD */) {
                notSupportedFilters.push({
                    lineNumber: i,
                    filter: line,
                    filterType,
