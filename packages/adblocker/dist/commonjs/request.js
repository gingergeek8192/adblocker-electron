...
exports.NORMALIZED_TYPE_TOKEN = {
    ...
    fedcm: (0, utils_js_1.fastHash)('type:script'),
    ...
    json: (0, utils_js_1.fastHash)('type:script'),
...
class Request {
    ...
    getTokens() {
        if (this.tokens === undefined) {
            ...
            (0, utils_js_1.tokenizeNoSkipInPlace)(this.normalizedUrl, tokens_buffer_js_1.TOKENS_BUFFER);
